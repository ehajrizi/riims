        ...
        <>
            <Grid>
                <Grid.Column width='14'>
                    <Header content='Anetaresimet' />
                </Grid.Column>
                <Grid.Column width='1' >
                    <Button onClick={() => modalStore.openModal(<AnetaresiaForm />)} as={Link} to='/createAnetaresia' className="btn" ><Icon className='btnIcon' name='plus' size='large' />
                    </Button>
                </Grid.Column>
            </Grid>
            <Divider />
